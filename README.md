...
🔹 Level 1: Basic (Must-know)
1️⃣ Swap Two Numbers (Without Third Variable)
...
Concepts: conditional operators / if-else

🔹 Level 2: Logic Building (Very Important)
...
Concepts: loops, variable shifting
...
🔹 Level 4: Arrays (Very Important in Placements)
1️⃣1️⃣ Find Largest Element in an Array

Problem:
Read an array and find the largest element.

1️⃣2️⃣ Reverse an Array

Problem:
Reverse the elements of an array.

1️⃣3️⃣ Search an Element (Linear Search)

Problem:
Check whether an element exists in an array.

🔹 Level 5: Strings (Often Asked)
1️⃣4️⃣ String Palindrome

Problem:
Check whether a string is a palindrome.

1️⃣5️⃣ Count Vowels in a String

Problem:
Count vowels in a given string.

🔹 Bonus: Tricky Placement Question 😈
1️⃣6️⃣ Remove Duplicate Elements from Array

Problem:
Remove duplicate values from an array without using another array.
